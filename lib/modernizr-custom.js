 ...
 * https://modernizr.com/download/?-devicemotion_deviceorientation-addtest-atrule-domprefixes-hasevent-mq-prefixed-prefixedcss-prefixedcssvalue-prefixes-printshiv-setclasses-testallprops-testprop-teststyles !*/
!function (e, t, n) {
    function r(e) {
    ...
    function a() {
        ...
        for (var l in _) if (_.hasOwnProperty(l)) {
            ...
            for (r = i(t.fn, "function") ? t.fn() : t.fn, o = 0; o < e.length; o++) a = e[o], s = a.split("."), 1 === s.length ? Modernizr[s[0]] = r : (!Modernizr[s[0]] || Modernizr[s[0]] instanceof Boolean || (Modernizr[s[0]] = new Boolean(Modernizr[s[0]])), Modernizr[s[0]][s[1]] = r), E.push((r ? "" : "no-") + s.join("-"))
        }
    }
    ...
    function c(e, n, r, o) {
        var i, a, s, l, c = "modernizr", d = u("div"), p = f();
        if (parseInt(r, 10)) for (; r--;) s = u("div"), s.id = o ? o[r] : c + (r + 1), d.appendChild(s);
        return i = u("style"), i.type = "text/css", i.id = "s" + c, (p.fake ? p : d).appendChild(i), p.appendChild(d), i.styleSheet ? i.styleSheet.cssText = e : i.appendChild(t.createTextNode(e)), d.id = c, p.fake && (p.style.background = "", p.style.overflow = "hidden", l = C.style.overflow, C.style.overflow = "hidden", C.appendChild(p)), a = n(d, e), p.fake ? (p.parentNode.removeChild(p), C.style.overflow = l, C.offsetHeight) : d.parentNode.removeChild(d), !!a
    }
    ...
    function g(e, t, o, a) {
        ...
        for (var f, c, p, m, h, g = ["modernizr", "tspan", "samp"]; !D.style && g.length;) f = !0, D.modElem = u(g.shift()), D.style = D.modElem.style;
        for (p = e.length, c = 0; p > c; c++) if (m = e[c], h = D.style[m], d(m, "-") && (m = r(m)), D.style[m] !== n) {
            if (a || i(o, "undefined")) return s(), "pfx" == t ? m : !0;
            try {
                D.style[m] = o
            } catch (y) {
            }
    ...
    function y(e, t, n, r, o) {
        ...
        return i(t, "string") || i(t, "undefined") ? g(s, t, r, o) : (s = (e + " " + j.join(a + " ") + a).split(" "), m(s, t, n))
    }
    ...
    var E = [], C = t.documentElement, b = "svg" === C.nodeName.toLowerCase(), _ = [], x = {
        _version: "3.6.0",
    ...
    Modernizr.prototype = x, Modernizr = new Modernizr, Modernizr.addTest("devicemotion", "DeviceMotionEvent" in e), Modernizr.addTest("deviceorientation", "DeviceOrientationEvent" in e);
    ...
    var N = "Moz O ms Webkit", j = x._config.usePrefixes ? N.toLowerCase().split(" ") : [];
    x._domPrefixes = j;
    var P = x._config.usePrefixes ? N.split(" ") : [];
    x._cssomPrefixes = P;
    var z = function (t) {
    ...
    var k = function () {
        function e(e, t) {
            var o;
            return e ? (t && "string" != typeof t || (t = u(t || "div")), e = "on" + e, o = e in t, !o && r && (t.setAttribute || (t = u("div")), t.setAttribute(e, ""), o = "function" == typeof t[e], t[e] !== n && (t[e] = n), t.removeAttribute(e)), o) : !1
        }
    ...
    x.hasEvent = k;
    var M = function (e, t) {
        var n = !1, r = u("div"), o = r.style;
        if (e in o) {
            var i = j.length;
            for (o[e] = t, n = o[e]; i-- && !n;) o[e] = "-" + j[i] + "-" + t, n = o[e]
        }
        return "" === n && (n = !1), n
    };
    x.prefixedCSSValue = M;
    b || !function (e, t) {
        function n(e, t) {
        ...
        function m(e) {
            ...
            return !N || e.printShived ? e : ("undefined" == typeof s[T] && s.add(T), l.attachEvent("onbeforeprint", function () {
                t();
    ...
    x.mq = A;
    var F = (x.testStyles = c, {elem: u("modernizr")});
    Modernizr._q.push(function () {
        delete F.elem
    });
    var D = {style: F.elem.style};
    ...
    var L = x.prefixed = function (e, t, n) {
        return 0 === e.indexOf("@") ? z(e) : (-1 != e.indexOf("-") && (e = r(e)), t ? y(e, t, n) : y(e, "pfx"))
    };
    x.prefixedCSS = function (e) {
        var t = L(e);
        return t && l(t)
    };
    x.testAllProps = S, a(), o(E), delete x.addTest, delete x.addAsyncTest;
